...
import com.example.motoengine.base.CommService
...
class BluetoothService(mContext: Context, mHandler: Handler) : CommService(mHandler) {
    ...
    inner class BtConnectThread(private val device: BluetoothDevice, secure: Boolean) : Thread() {
        ...
        override fun run() {
            ...
            synchronized(this@BluetoothService) { mBtConnectThread = null }
